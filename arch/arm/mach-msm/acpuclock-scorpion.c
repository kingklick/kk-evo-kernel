...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{  19200, CCTL(CLK_TCXO, 1),		SRC_RAW, 0, 0, 850, 14000}, // 925
	{ 128000, CCTL(CLK_TCXO, 1),		SRC_AXI, 0, 0, 850, 14000 }, // 925
	{ 245760, CCTL(CLK_MODEM_PLL, 1),	SRC_RAW, 0, 0, 850, 29000 }, // change vdd to 1000
